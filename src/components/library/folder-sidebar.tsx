...
export function FolderSidebar() {
  const { folders, activeFolder, setActiveFolder, addFolder } = useLibraryStore();
...
function FolderIcon({ type }: { type: string }) {
  if (type === "favorites") {
    return (
      <span className="flex h-5 w-5 items-center justify-center rounded bg-red-100 text-xs">
        ❤
      </span>
    );
  }
  if (type === "team") {
    return (
      <span className="flex h-5 w-5 items-center justify-center rounded bg-purple-100 text-[10px]">
        👥
      </span>
    );
  }
  return (
    <span className="flex h-5 w-5 items-center justify-center rounded bg-orange-100 text-xs">
      📁
    </span>
  );
}
...
function BrowseIcon() {
  return (
    <span className="flex h-5 w-5 items-center justify-center rounded bg-purple-100 text-xs">
      📚
    </span>
  );
}
